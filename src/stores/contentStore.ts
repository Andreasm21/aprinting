...
const defaultContent: SiteContent = {
  ...
  pricing: {
    fdm: [
      { material: 'PLA', price: '€0.05', min: '€5' },
      { material: 'PETG', price: '€0.07', min: '€7' },
      { material: 'TPU', price: '€0.10', min: '€8' },
    ],
    resin: [
      { type: 'Standard', price: '€0.12', min: '€10' },
      { type: 'High-Detail', price: '€0.18', min: '€12' },
      { type: 'Tough/Flex', price: '€0.20', min: '€15' },
    ],
    designRate: '€15',
  },
}
